...
class BoardRepositoryImp:BoardRepository {
    ...
    //上
    override fun findUpMovePiece(x: Int, y: Int): Boolean {
        return board.cells[x][y].piece.equalUpMovePiece()
    }

    //下
    override fun findDownMovePiece(x: Int, y: Int): Boolean {
        return board.cells[x][y].piece.equalDownMovePiece()
    }

    //横
    override fun findLRMovePiece(x: Int, y: Int): Boolean {
        return board.cells[x][y].piece.equalLRMovePiece()
    }

    //斜め上
    override fun findDiagonalUp(x: Int, y: Int): Boolean {
        return board.cells[x][y].piece.equalDiagonalUp()
    }

    //斜め下
    override fun findDiagonalDown(x: Int, y: Int): Boolean {
