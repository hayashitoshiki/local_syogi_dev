...
class SignInUpFragment : Fragment(), SignInUpContact.View {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val mPasswordField3 = view.findViewById(R.id.password_edit_text3) as EditText
        val userNameField = view.findViewById(R.id.userName_edit_text2) as EditText
        ...
        button2.setOnClickListener {
            presenter.signUp(
                ...
                mEmailField2.text.toString(),
                mPasswordField2.text.toString(),
                mPasswordField3.text.toString())
        }
        return view
    }
